...
![Extrapolated Graph example 1](https://github.com/nachiketbhatt/Graphybara/blob/master/docs/extrapolated_graph_example1.PNG)![Extrapolated Graph example 2](https://github.com/nachiketbhatt/Graphybara/blob/master/docs/extrapolated_graph_example2.PNG)  
...
![Straight line example](https://github.com/nachiketbhatt/Graphybara/blob/master/docs/stright_line_example.PNG)
```javascript
...
![Curved Example](https://github.com/nachiketbhatt/Graphybara/blob/master/docs/curved_example.PNG)
```javascript
...
![L shape example](https://github.com/nachiketbhatt/Graphybara/blob/master/docs/l_shaped_example.PNG)
```javascript
...
![Z shaped example](https://github.com/nachiketbhatt/Graphybara/blob/master/docs/z_shape_example.PNG)
```javascript
